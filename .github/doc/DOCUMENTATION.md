...
| **Are there any premade modpacks for new models that I can drag & drop to my server?**                      | Sure, the community has created many new object, vehicle and skin mods over the years. You can search for these models online. [You can find more information here about adding all of SA-MP's objects.](/newmodels_red/models/object/1337/SAMP/README.md) |
...
Models can be customized with `<new_model_id>.txt` files. Check [this README](/newmodels_red/models/README.md) for more information.
